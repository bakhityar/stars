...
public class StarRepository {
  private static final List<Star> ALL_STARS = Arrays.asList(
      new Star ("Mercury", "25.56", "56.80", "red", "Galileo"),
      new Star ("Venus", "57.56", "186.80", "white", "Kopernick"),
      new Star ("Earth", "33.56", "90.80", "orange", "Archimedus"),
      new Star ("Mars", "12.56", "72.80", "yellow", "Galileo"),
      new Star ("Jupiter", "125.56", "212.80", "red", "Ulugbek")
  );
